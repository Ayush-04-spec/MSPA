    ...
    <>
      <Tilt tiltMaxAngleX={3} tiltMaxAngleY={3} glareEnable glareMaxOpacity={0.04}
        ...
        >
          ...
          <div className="card-icon-slot" style={{ background: cat.bg, borderColor: cat.color + "33" }}>
          ...
          <div className="card-main">
            ...
            <div className="card-meta">
              ...
              {mla && <><span className="card-meta-sep">•</span><span style={{ color: "#4A78E0" }}>✓ {mla.name}</span></>}
      ...
      {expanded && (
        <div className="card-expanded" onClick={e => e.stopPropagation()}>
          ...
          {isAdmin && !showMlaSelect && (
            <select className="input select-sm" style={{ marginTop: 10, maxWidth: 220 }}
          ...
          {isAdmin && showMlaSelect && (
            <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
              <select className="input select-sm" value={selectedMla}
              ...
              <button className="btn btn-primary" style={{ padding: "6px 12px", fontSize: "0.8rem" }} onClick={confirmResolve}>Confirm</button>
              <button className="btn btn-outline" style={{ padding: "6px 12px", fontSize: "0.8rem" }} onClick={() => setShowMlaSelect(false)}>Cancel</button>
            </div>
          )}
